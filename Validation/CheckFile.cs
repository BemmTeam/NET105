...
namespace System.ComponentModel.DataAnnotations {
    ...
    public sealed class CheckFileAttribute : DataTypeAttribute {
        private string _extensions;

        public CheckFileAttribute()
            : base(DataType.Upload) {

            // DevDiv 468241: set DefaultErrorMessage not ErrorMessage, allowing user to set
            // ErrorMessageResourceType and ErrorMessageResourceName to use localized messages.
            ErrorMessage = "Chỉ được upload các file {1}";
        }
        ...
        public override bool IsValid(object value) {
            ...
            if(file != null)
            {
                return ValidateExtension(file.FileName);
            }
